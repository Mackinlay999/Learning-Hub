...
const allSections = [
  ...
  },
  {
    name: "Mentor",
    icon: <ShieldCheck size={18} />,
    path: "/admin/admin-mentors",
    roles: ["Mentor", "Admin", "Super Admin"],
  },
  {
    name: "Email Marketing",
    icon: <Mail size={18} />,
    path: "/admin/admin-email-marketing",
    roles: ["Admin", "Super Admin"],
  },
  {
    name: "Recruiter Dashboard",
    icon: <ShieldCheck size={18} />,
    path: "/admin/admin-recruiters/dashboard",
    roles: ["Recruiter", "Super Admin"],
  },
  {
    name: "Finance & Payment",
    icon: <CreditCard size={18} />,
    path: "/admin/admin-finance-payment",
    roles: ["Admin", "Super Admin"],
  },
  {
    name: "Corporate Training",
    icon: <Building2 size={18} />,
    path: "/admin/admin-corporate-training",
    roles: ["Admin", "Super Admin"],
  },
  {
    name: "Analytics & Reports",
    icon: <BarChart2 size={18} />,
    path: "/admin/admin-analytics-reports",
    roles: ["Admin", "Super Admin"],
  },
  {
    name: "Support & Feedback",
    icon: <MessageCircle size={18} />,
    path: "/admin/admin-support-feedback",
    roles: ["Admin", "Mentor", "Recruiter", "Super Admin"],
  },
  {
    name: "Sucess Story",
    icon: <Briefcase size={18} />,
    path: "/admin/admin-Suceess",
    roles: ["Admin", "Mentor", "Super Admin"],
  },
  {
    name: "Blog & Webinar",
    icon: <ShieldCheck size={18} />,
    path: "/admin/admin-blog-webinar",
    roles: ["Admin", "Super Admin"],
  },
];
