      ...
      <Row className="blog-webinar-align-items-center justify-content-between mb-4">
        ...
        <Col xs={12} md="auto" className="mt-3 mt-md-0">
          <ButtonGroup className="blog-webinar-button-group">
            <Button
              className={`blog-webinar-button ${tab === 'blog' ? 'blog-webinar-button-primary' : 'blog-webinar-button-secondary'}`}
              onClick={() => setTab('blog')}
            >
              Blog
            </Button>
            <Button
              className={`blog-webinar-button ${tab === 'webinar' ? 'blog-webinar-button-primary' : 'blog-webinar-button-secondary'}`}
        ...
        >
          ...
          <Form onSubmit={handleBlogSubmit}>
            <Form.Group className="blog-webinar-form-group mb-3">
              <Form.Label className="blog-webinar-form-label">Blog Title</Form.Label>
              <Form.Control
            ...
            <Form.Group className="blog-webinar-form-group mb-3">
              <Form.Label className="blog-webinar-form-label">Blog Content</Form.Label>
              <Form.Control
                className="blog-webinar-form-control"
                as="textarea"
                rows={6}
            ...
            <Form.Group className="blog-webinar-form-group mb-3 d-flex align-items-center gap-3">
              <Form.Label className="blog-webinar-switch-label mb-0">Publish:</Form.Label>
              <Form.Check
                type="switch"
                id="publish-switch"
                checked={publish}
            ...
            <Button type="submit" className="blog-webinar-button-schedule" variant="success">
              Schedule Content
            </Button>
          </Form>
        </motion.div>
      ...
      {tab === 'webinar' && (
        ...
        >
          ...
          <Form onSubmit={handleWebinarSubmit}>
            <Form.Group className="blog-webinar-form-group mb-3">
              <Form.Label className="blog-webinar-form-label">Webinar Title</Form.Label>
              <Form.Control
                className="blog-webinar-form-control"
                type="text"
            ...
            <Form.Group className="blog-webinar-form-group mb-3">
              <Form.Label className="blog-webinar-form-label">Date & Time</Form.Label>
              <Form.Control
                className="blog-webinar-form-control"
                type="datetime-local"
            ...
            <Form.Group className="blog-webinar-form-group mb-3">
              <Form.Label className="blog-webinar-form-label">Webinar Description</Form.Label>
              <Form.Control
                className="blog-webinar-form-control"
                as="textarea"
                rows={4}
            ...
            <div className="d-flex flex-wrap gap-3">
              <Button type="submit" className="blog-webinar-button-view" variant="primary">
                View Registrants
              </Button>
