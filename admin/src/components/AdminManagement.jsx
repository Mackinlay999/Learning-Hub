...
//           `/admin/update-role`,
//           {
//             id: editId,             // the user's ID to be updated
//             name: formData.username,    // the updated name
//             email: formData.email,  // the updated email
//             role: formData.role     // the updated role
//           },
//           {
...
//         // Correct the request body structure
//         await axios.delete(`/admin/deleteUser`, {
//           data: { userIdToDelete: id },  // Sending the ID of the user to be deleted
